...
async function studentCreate() {
    ...
    let bodyJson = {
        "firstName": firstName, "lastName": lastName, "email": email, "major": major, "gpa": gpa, "coursesTaken": [],
    }
...
async function studentUpdate() {
    ...
    let bodyJson = {
        "id": id,  "firstName": firstName, "lastName": lastName, "email": email, "major": major, "gpa": gpa, "coursesTaken": [],
    }
...
async function studentDelete(id) {
    const rawResponse = await fetch(`${BASE_URL}/students/` + id, {
        method: 'DELETE',
        headers: {
            'Accept': 'application/json',
            'Content-Type': 'application/json'
